...
const uint8_t cryptFloorData[] = {8, 8, 1, 0, 0, 0xFF, 1, 0x66, 0x66,0x66, 0x66,0x66, 0x66,0x66, 0x66,0x66, 0x66,0xe6, 0x66,0x66, 0x6e,0xee, 0x66,0x66, 0xee,0xee, 0xe6,0x66, 0x6e,0xee, 0x66,0x66, 0x66,0xe6, 0x66,0x66, 0x66,0x66, 0x66};
Image cryptFloor = Image(cryptFloorData);
const uint8_t palaceFloorData[] = {8, 8, 1, 0, 0, 0xFF, 1, 0x55, 0x55,0xff, 0xff,0x55, 0x55,0xff, 0xff,0x55, 0x55,0xff, 0xff,0x55, 0x55,0xff, 0xff,0xff, 0xff,0x55, 0x55,0xff, 0xff,0x55, 0x55,0xff, 0xff,0x55, 0x55,0xff, 0xff,0x55, 0x55};
Image palaceFloor = Image(palaceFloorData);
...
const uint8_t cryptWallData[] = {8, 8, 2, 0, 0, 0xFF, 1, 0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x99, 0x99,0x99, 0x99,0x99, 0x99,0x99, 0x99,0x99, 0x99,0x99, 0x99,0x99, 0x99,0x99, 0x99,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22,0x22, 0x22};
Image cryptWall = Image(cryptWallData);
...
const uint8_t statueData[] = {8, 8, 1, 0, 0, 0x0E, 1, 0xe4, 0x44,0x44, 0x4e,0xe9, 0x99,0x99, 0x9e,0xee, 0x9a,0xa9, 0xee,0xee, 0x9a,0xa9, 0xee,0xee, 0x9a,0xa9, 0xee,0xee, 0x9a,0xa9, 0xee,0xe4, 0x9a,0xa9, 0x4e,0xe9, 0x99,0x99, 0x9e};
...
void World::drawWall(byte x, byte y, byte frame) {
  switch(currentWorld) {
    ...
    case 2:
      ...
      break;
    case 3:
      cryptWall.setFrame(frame);
      gb.display.drawImage(camera.screenPosX(x), camera.screenPosY(y), cryptWall);
      break;
    default:
      wallTile.setFrame(frame);
      gb.display.drawImage(camera.screenPosX(x), camera.screenPosY(y), wallTile);
...
void World::drawFloor(byte x, byte y) {
  switch(currentWorld) {
    ...
    case 2:
      ...
      break;
    case 3:
      gb.display.drawImage(camera.screenPosX(x), camera.screenPosY(y), cryptFloor);
      break;
    default:
      gb.display.drawImage(camera.screenPosX(x), camera.screenPosY(y), floorTile);
      break;
...
void World::drawObstacle(byte x, byte y) {
  switch(currentWorld) {
    ...
    case 2:
      ...
      break;
    case 3:
      gb.display.drawImage(camera.screenPosX(x), camera.screenPosY(y)-1, statue);
      break;
    default:
      gb.display.drawImage(camera.screenPosX(x), camera.screenPosY(y), grave);
      break;
